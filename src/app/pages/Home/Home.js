...
const Home = () => {
    ...
    <div >
        ...
        <div className="home"><Image  className="imag" src={greet} alt="portfolio"/> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;  &nbsp; &nbsp;&nbsp; &nbsp;<br/ 
            <h2 className='home3'><b className="intra"> >WELCOME TO MY</b> &nbsp;</h2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;<Image className="imag" src={pf} alt="portfolio"/></div>
